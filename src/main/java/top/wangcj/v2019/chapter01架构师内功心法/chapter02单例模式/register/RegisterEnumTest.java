...
public class RegisterEnumTest {
    ...
    public static void main(String[] args) {
        try {
            Constructor<?> declaredConstructor = Class.forName("top.wangcj.v2019.chapter01架构师内功心法.chapter02单例模式.register.RegisterEnum")
    ...
    public void testTom() {
        try {
            ...
            //会初始化静态成员，有输出
            Class<?> aClass = Class.forName("top.wangcj.v2019.chapter01架构师内功心法.chapter02单例模式.register.Tom");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
